...
const RequestBlock: React.FC<ShareInfoProps> = ({
  title,
  text,
  backgroundColor,
}) => {
  ...
  return (
    <div className={style.container}>
      ...
      >
        <h2>{title}</h2>
        <p>{text}</p>
        <input className={style.name} type="text" placeholder="Our Name" />
        <input
        ...
        <Button
          text="Send request"
          width="150px"
          onClick={() => alert("Your data has been sent!")}
